...
const EditorTab: React.FC<EditorTabProps> = ({ system, versionedResource }) => {
  const editor = editorState.useValue()

  const { actions } = useEditor()

  useEffect(() => {
    let lexical = versionedResource.data.pages.find((p: PageData) => p.name === editor.characterPage)?.lexical
