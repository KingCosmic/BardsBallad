import { IonBackButton, IonButton, IonButtons, IonContent, IonHeader, IonIcon, IonMenuButton, IonPage, IonSelect, IonSelectOption, IonSplitPane, IonTitle, IonToolbar } from '@ionic/react'
import './Page.css'
  ...
  return (
    <IonPage>
      ...
      <IonContent className='ion-padding' fullscreen>
        ...
        <div className='ion-hide-md-down' style={{ overflowX: 'scroll' }}>
          <IonButtons>
            <IonButton
        ...
        <IonSelect className='ion-margin-bottom ion-hide-md-up' label='Tab'
          fill='outline'
          value={tab}
